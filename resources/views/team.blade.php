                ...
                <div class="col-lg-6 pe-lg-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="display-5 text-primary mb-0">
                            <img src="img/logo.jpg" alt="" style="width:10rem; height:100px;" >
                        </h1>
                    </a>
                    <p class="text-white mt-3">
                        At Jay’s Beauty, we believe in redefining confidence through style and self-care. 
                        Our salon in Hounslow offers professional beauty treatments and personalised experiences 
                        designed to make you look and feel your absolute best.
                    </p>
                    <p class="mb-2 text-white"><i class="fa fa-map-marker-alt me-2 text-primary"></i>Hounslow Market, Hounslow, UK</p>
                    <p class="mb-2 text-white"><i class="fa fa-phone-alt me-2 text-primary"></i>+44 - 7399 001 499</p>
                    <p class="mb-2 text-white"><i class="fa fa-envelope me-2 text-primary"></i>info@jaysbeauty.co.uk</p>
                ...
                <div class="col-lg-6 ps-lg-5">
                    <div class="row g-4">
                        <div class="col-sm-6">
                            ...
                            <a class="btn btn-link text-white-50" href="#">Our Pages</a>
                            <a class="btn btn-link text-white-50" href="#">Gallery</a>
                            <a class="btn btn-link text-white-50" href="#">Contact Us</a>
                        </div>
                        <div class="col-sm-6">
                            <h5 class="text-primary mb-4">Opening Hours</h5>
                            <p class="text-white mb-1">Mon – Sat: 9:00 AM – 7:00 PM</p>
                            <p class="text-white mb-0">Sunday: Closed</p>
                        </div>
        ...
        <div class="container">
            <div class="row">
                 <div class="col-sm-12 mt-4">
                    <p class="mb-0 text-center text-white mt-3">
                        Design by <a href="https://thenexteck.com" class="text-primary">Thenexteck.com</a><br>
                        Copyright © Jay’s Beauty, Hounslow
                    </p>
                </div>
            </div>
        </div>
