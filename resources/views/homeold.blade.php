						...
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									...
									<div class="button">
										<a href="{{ url('/appointment') }}" class="btn">Get Appointment</a>
										<a href="{{ url('/contact') }}" class="btn primary">Contact Now</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="single-schedule first">
								<div class="inner">
									...
									<div class="single-content">
										...
										<a href="#emergency">LEARN MORE<i class="fa fa-long-arrow-right"></i></a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="owl-carousel portfolio-slider">
							<div class="single-pf">
								<img src="{{ asset('img/pf1.jpg') }}" alt="#">
								<a href="portfolio-details.html" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="{{ asset('img/pf2.jpg') }}" alt="#">
								<a href="portfolio-details.html" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="{{ asset('img/pf3.jpg') }}" alt="#">
								<a href="portfolio-details.html" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="{{ asset('img/pf4.jpg') }}" alt="#">
								<a href="portfolio-details.html" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="{{ asset('img/pf1.jpg') }}" alt="#">
